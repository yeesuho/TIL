...
유튜브 쇼츠로 돈 번다는 사람들이 있다는 영상을 보고나서 솔직히 나도 할 수 있을거 같다는 생각을 해봣습니다 근데 생각만 해보고 시도해보진 않았습니다;;

주제 선정이나 영상의 내용 등등 시간도 부족하고 귀찮기도해서 해보고 싶다는 생각만 남긴채 삶을 살아가고 있었는데 inflearn 강의에서 유튜브 쇼츠 자동화 `with n8n` 강의가 딱 알고리즘에 뜨는거 아니겠습니까?? (심지어 자주 보는 강사분)

근데 가격이 좀 부담돼서 당장 구매는 못하고 n8n을 태어나서 처음본 저는 일단 해봐야 실패를 하던 성공을 하든 한다고 생각해서 제일 잘하는 맨땅에 헤딩 느낌으로 강의 커리큘럼을 gpt에게 보여주고 나 이거 해보고 싶어 "해줘"를 시전해보았습니다..




먼저 n8n은 여러 서비스를 노드로 연결해서 자동화하는 도구라는데
